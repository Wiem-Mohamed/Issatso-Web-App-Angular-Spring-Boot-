...
import avisResolve from './avis-routing-resolve.service';

describe('Avis routing resolve service', () => {
  let mockRouter: Router;
  let mockActivatedRouteSnapshot: ActivatedRouteSnapshot;
  let service: AvisService;
  let resultAvis: IAvis | null | undefined;
  ...
  describe('resolve', () => {
    it('should return IAvis returned by find', () => {
      ...
      TestBed.runInInjectionContext(() => {
        avisResolve(mockActivatedRouteSnapshot).subscribe({
          next(result) {
            resultAvis = result;
          },
        });
    ...
    it('should return null if id is not provided', () => {
      ...
      expect(resultAvis).toEqual(null);
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse<IAvis>({ body: null })));
      mockActivatedRouteSnapshot.params = { id: 123 };
